...
export default function Contact() {
  return (
    <Container id={"contact"} className={"bg-[#FFF2F3]"}>
      <div className="h-[37.125rem] md:w-[65.625rem] py-[10rem] flex flex-col justify-center gap-y-[5rem]">
        <TitleGroup
          itemsCentered
        ...
        />
        <div className=" md:w-[43rem] w-[20rem] md:h-[3.625rem] h-[2rem] relative flex self-center border border-[#E6E6E6] bg-[#F9F9F9]">
          <input
