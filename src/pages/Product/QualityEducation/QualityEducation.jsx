...
export default function QualityEducation() {
  return (
    <div className=" md:w-[65.625rem] md:h-[45.1593rem] py-[10rem] flex justify-between items-center flex-col md:flex-row mt-7 md:mt-0">
      ...
      <div className=" md:w-[23.8125rem] md:h-[18.5rem] flex flex-col md:gap-y-[2.1875rem] gap-y-5 mt-7">
        <UnderLine />{" "}
